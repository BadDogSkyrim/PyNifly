...
# These hold each output path RELATIVE to 'meshes' (e.g. meshes\morphs\...\morph.dat), recorded on
...
_EXPORT_ROOT_FIELDS = ['blender_xf', 'write_bodytri', 'write_tris', 'write_sf_materials',
