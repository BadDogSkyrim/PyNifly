...
extern "C" NIFLY_API int getSubsegmentCutOffsets(void* nifref, void* shaperef, int subsegID, float* buf, int buflen);
...
extern "C" NIFLY_API void setSegments(void* nifref, void* shaperef, uint16_t * segData, int segDataLen, uint32_t * subsegData, int subsegDataLen, uint16_t * tris, int triLen, const char* filename, uint32_t * cutCounts, int cutCountsLen, float* cutData, int cutDataLen);
...
extern "C" NIFLY_API int getConnectPointParentCount(void* nifref);
extern "C" NIFLY_API int getConnectPointParents(void* nifref, int buflen, ConnectPointBuf* buf);
...
extern "C" NIFLY_API int getConnectPointChildLen(void* nifref);
extern "C" NIFLY_API int getConnectPointChildren(void* nifref, int buflen, char* buf);
...
extern "C" NIFLY_API int getExtraData(void* nifref, uint32_t id,
...
extern "C" NIFLY_API int setCollMoppCode(void* nifref, int blockID, float* originXYZ, float scale, uint8_t* moppBytes, int moppLen, uint8_t buildType);
