...
//struct BSLSPAttrs : BSShaderPropertyBuf {
//	float Emissive_Color_R;
//	float Emissive_Color_G;
//	float Emissive_Color_B;
//	float Emissive_Color_A;
...
//struct BSESPAttrs {
//	uint16_t bufSize = sizeof(BSESPAttrs);
//	uint16_t bufType = BUFFER_TYPES::BSESPAttrsType;
//	uint32_t nameID;
//	uint32_t controllerID;
//	uint16_t extraDataCount;
//	uint32_t Shader_Flags_1;
...
//extern "C" NIFLY_API void getInvMarker(void* nifref, void* inbuf);
