...
extern "C" NIFLY_API int getClothExtraDataLen(void* nifref, void* shaperef, int idx, int* valuelen);
extern "C" NIFLY_API int getClothExtraData(void* nifref, void* shaperef, int idx, char* buf, int buflen);
extern "C" NIFLY_API void setClothExtraData(void* nifref, char* buf, int buflen);
