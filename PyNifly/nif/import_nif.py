...
class NifImporter():
    ...
    def import_ninode(self, arma, ninode:NiNode, parent=None):
        ...
        * Returns the Blender representation of the node, either an object or a bone, or
        ...
        if ninode.id == 0: 
            ...
            obj["pynRoot"] = True
            obj["PYN_BLENDER_XF"] = MatNearEqual(self.import_xf, BD.blender_import_xf)
    ...
    def import_nif(self, priors=None):
        ...
        for s in self.nif.shapes:
            ...
            # if connectpoint.is_editor_marker(s):
...
class ImportNIF(bpy.types.Operator, ImportHelper):
    ...
    smart_editor_markers: bpy.props.BoolProperty(
        ...
        default=BD.SMART_EDITOR_MARKERS_DEF
    ) # type: ignore
